...
const Button = ({
  ...
  const variantClasses = {
    primary: 'bg-primary hover:bg-primary/90 text-white focus:ring-primary shadow-sm hover:shadow-md',
  ...
  return (
    ...
    >
      ...
      {!loading && icon && iconPosition === 'left' && (
        <i className={`bi ${icon} mr-2`} aria-hidden="true"></i>
      )}
      {children}
      {!loading && icon && iconPosition === 'right' && (
        <i className={`bi ${icon} ml-2`} aria-hidden="true"></i>
      )}
    </button>
  );
};
